(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();function e(e,t){e.innerHTML=`
  ...
  `,document.getElementById(`close-roadmap`).addEventListener(`click`,()=>{t()})}document.addEventListener(`DOMContentLoaded`,()=>{`serviceWorker`in navigator&&navigator.serviceWorker.register(`/Unplug/sw.js`).then(e=>console.log(`SW registered: `,e.scope)).catch(e=>console.log(`SW registration failed: `,e));let t={onboarding:document.getElementById(`screen-onboarding`),timer:document.getElementById(`screen-timer`),active:document.getElementById(`screen-active`),summary:document.getElementById(`screen-summary`),roadmap:document.getElementById(`screen-roadmap`)};function n(r){Object.values(t).forEach(e=>{e&&e.classList.remove(`active`)}),t[r]&&(t[r].classList.add(`active`),r===`roadmap`&&e(document.getElementById(`roadmap-container`),()=>n(`summary`)))}document.querySelectorAll(`[data-goto]`).forEach(e=>{e.addEventListener(`click`,e=>{let t=e.currentTarget.dataset.goto;n(t)})});let r=document.getElementById(`dial-container`),i=document.getElementById(`dial-progress`),a=document.getElementById(`dial-hit-area`),o=document.getElementById(`dial-time`),s=document.getElementById(`active-time`),c=document.getElementById(`summary-time`),l=30,u=2*Math.PI*45;function d(e){l=Math.max(1,Math.min(e,60));let t=`${l.toString().padStart(2,`0`)}:00`;o.textContent=t,s.textContent=t,c.textContent=`${l}m`;let n=u-l/60*u;i.style.strokeDashoffset=n}i.style.strokeDasharray=u,d(l);let f=!1;function p(e){if(!r)return;let t=r.getBoundingClientRect(),n=t.left+t.width/2,i=t.top+t.height/2,a=e.clientX,o=e.clientY;e.touches&&e.touches.length>0&&(a=e.touches[0].clientX,o=e.touches[0].clientY);let s=a-n,c=o-i,l=180/Math.PI*Math.atan2(c,s);l+=90,l<0&&(l+=360);let u=Math.round(l/360*60);u===0&&(u=60),d(u)}a.addEventListener(`pointerdown`,e=>{f=!0,p(e),a.setPointerCapture(e.pointerId)}),a.addEventListener(`pointermove`,e=>{f&&p(e)}),a.addEventListener(`pointerup`,e=>{f=!1,a.releasePointerCapture(e.pointerId)}),a.addEventListener(`pointercancel`,e=>{f=!1})});