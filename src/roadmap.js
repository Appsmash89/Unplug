  ...
  container.innerHTML = `
    <div class="max-w-4xl mx-auto">
      ...
      <div class="space-y-8 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-1 before:bg-surfaceContainer">
        ...
        <!-- Mission 3 -->
        <div class="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
          <div class="flex items-center justify-center w-10 h-10 rounded-full bg-surface ring-4 ring-primary/10 text-primary font-bold shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 z-10 shadow-sm">
            <span class="w-3 h-3 bg-primary animate-pulse rounded-full"></span>
          </div>
          <div class="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-surface p-6 rounded-2xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] ring-4 ring-primary/10">
            <div class="flex justify-between items-center mb-2">
                <h3 class="font-heading font-bold text-primary text-xl">Mission 3</h3>
                <span class="text-xs font-bold uppercase tracking-wider text-primary bg-primary/10 px-3 py-1 rounded-full">In Progress</span>
            </div>
        ...
        <div class="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
          <div class="flex items-center justify-center w-10 h-10 rounded-full bg-surfaceContainer ring-4 ring-surface shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 z-10 shadow-sm relative overflow-hidden">
             <!-- Empty state -->
          </div>
          <div class="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-transparent p-6 rounded-2xl">
            <div class="flex justify-between items-center mb-2">
                <h3 class="font-heading font-bold text-gray-400 text-xl">Mission 4</h3>
                <span class="text-xs font-bold uppercase tracking-wider text-gray-500 bg-surfaceContainer px-3 py-1 rounded-full">Pending</span>
            </div>
            <p class="text-sm text-gray-500 font-medium mb-1">PWA & Store Packaging</p>
            <p class="text-sm text-gray-400">Transforming SPA into an installable PWA and packaging for the Google Play Store via Bubblewrap.</p>
          </div>
        </div>
